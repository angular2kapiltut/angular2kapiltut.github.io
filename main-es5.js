...
var angservicesComponent = /** @class */ (function () {
    function angservicesComponent() {
    ...
    // input properties 
    angservicesComponent.prototype.getTotalFriendsCount = function () {
        return this.friends.length;
    };
    angservicesComponent.prototype.getTotalMaleFriendsCount = function () {
        return this.friends.filter(function (f) { return f.gender === "Male"; }).length;
    };
    angservicesComponent.prototype.getTotalFemaleFriendsCount = function () {
        return this.friends.filter(function (f) { return f.gender === "Female"; }).length;
    };
    //output
    angservicesComponent.prototype.onFriendCountRadioButtonChange = function (selectedRadioButtonValue) {
...
var friendscountComponent = /** @class */ (function () {
    function friendscountComponent() {
    ...
    friendscountComponent.prototype.onRadioButtonSelectionChangen = function () {
...
var cmpntoutputprtsComponent = /** @class */ (function () {
    function cmpntoutputprtsComponent() {
    ...
    cmpntoutputprtsComponent.prototype.getTotalEmployessCount1 = function () {
        return this.adpemployees.length;
    };
    cmpntoutputprtsComponent.prototype.getTotalMaleEmployessCount1 = function () {
        return this.adpemployees.filter(function (g) { return g.gender === "male"; }).length;
    };
    cmpntoutputprtsComponent.prototype.getTotalFeMaleEmployessCount1 = function () {
        return this.adpemployees.filter(function (g) { return g.gender === "female"; }).length;
    };
    cmpntoutputprtsComponent.prototype.OnEmployeeCountRadioButtonChange = function (selectedRadioButtonValue) {
    ...
    return cmpntoutputprtsComponent;
}());
...
var employeecount1Component = /** @class */ (function () {
    function employeecount1Component() {
    ...
    employeecount1Component.prototype.onRadioButtonSelectionChangen = function () {
    ...
    return employeecount1Component;
}());
...
var containernestedcmpntComponent = /** @class */ (function () {
    function containernestedcmpntComponent() {
        this.employees = [
            { code: 'emp01', name: 'tom', gender: 'male', DateofBirth: '6/25/2018', salary: '40000' },
    ...
    containernestedcmpntComponent.prototype.getTotalEmployessCount = function () {
        return this.employees.length;
    };
    containernestedcmpntComponent.prototype.getTotalMaleEmployessCount = function () {
        return this.employees.filter(function (e) { return e.gender === "male"; }).length;
    };
    containernestedcmpntComponent.prototype.getTotalFeMaleEmployessCount = function () {
    ...
    return containernestedcmpntComponent;
}());
...
var custompipesComponent = /** @class */ (function () {
    ...
    custompipesComponent.prototype.getEMployess = function () {
        this.employees = [
            { code: 'emp01', name: 'tom', gender: 'male', DateofBirth: '6/25/2018', salary: '40000' },
            { code: 'emp02', name: 'jay', gender: 'male', salary: '40000' },
            { code: 'emp03', name: 'parvathi', gender: 'male', DateofBirth: '31/06/22018', salary: '40000' },
    ...
    custompipesComponent.prototype.trackByEmpCode = function (index, employee) {
...
var custompipes = /** @class */ (function () {
    ...
    custompipes.prototype.transform = function (value, gender) {
...
var ngfortrackbyComponent = /** @class */ (function () {
    function ngfortrackbyComponent() {
        this.employees = [
            { code: 'emp01', name: 'tom' },
            { code: 'emp02', name: 'jay' },
            { code: 'emp03', name: 'parvathi' }
    ...
    ngfortrackbyComponent.prototype.getEMployess = function () {
        this.employees = [
            { code: 'emp01', name: 'tom' },
            { code: 'emp02', name: 'jay' },
            { code: 'emp03', name: 'parvathi' },
    ...
    ngfortrackbyComponent.prototype.trackByEmpCode = function (index, employee) {
        return employee.code;
    };
...
var pipesComponent = /** @class */ (function () {
    ...
    pipesComponent.prototype.getEMployess = function () {
        this.employees = [
            { code: 'emp01', name: 'tom' },
            { code: 'emp02', name: 'jay' },
            { code: 'emp03', name: 'parvathi' },
    ...
    pipesComponent.prototype.trackByEmpCode = function (index, employee) {
        return employee.code;
    };
...
var stylebindingComponent = /** @class */ (function () {
    ...
    stylebindingComponent.prototype.addStyles = function () {
        var styles = {
...
var twaybindingComponent = /** @class */ (function () {
    function twaybindingComponent() {
        this.name = 'jay';
    }
